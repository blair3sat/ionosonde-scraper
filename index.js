...
info={method:"post",url:"https://www.ukssdc.ac.uk/cgi-bin/digisondes/cost_database.pl",headers:{ 'Authorization': 'Basic ' + btoa('ryan.tse@blair3sat.com:'), 'content-type' : 'application/x-www-form-urlencoded'},body:{ 'retrieve': 'Retrieve data', 'ursi': 'at138', 'datetype': 'range', 'syear': sma.get("year").toString(), 'smonth': sma.get("month").toString(),
